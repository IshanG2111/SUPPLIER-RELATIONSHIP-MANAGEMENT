...
export function Modal({ title, children, isOpen, onClose, size = 'md' }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/45 p-4 backdrop-blur-md animate-in fade-in duration-200">
      <div className={`w-full ${sizes[size] || 'max-w-xl'} max-h-[calc(100vh-2rem)] flex flex-col rounded-2xl bg-white/80 dark:bg-[#0f172a]/90 backdrop-blur-xl border border-white/20 dark:border-[#1e293b]/70 shadow-2xl transition-all duration-200 animate-in zoom-in-95 duration-200`}>
        <div className="flex items-center justify-between border-b border-slate-100/50 dark:border-[#1e293b]/50 px-5 py-4 flex-shrink-0">

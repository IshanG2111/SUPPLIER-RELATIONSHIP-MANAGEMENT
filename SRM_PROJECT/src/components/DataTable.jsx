        ...
        <div className="flex items-center justify-between px-5 py-3 border-t border-slate-200 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-900/40 text-xs shrink-0 select-none">
          ...
          <div className="flex items-center gap-1.5">
            <button
              ...
              className="inline-flex items-center justify-center h-8 w-8 rounded-lg border border-slate-200 dark:border-slate-800 bg-white dark:bg-[#090f1e]/80 text-slate-600 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-slate-800 hover:text-slate-900 dark:hover:text-slate-200 disabled:opacity-30 disabled:cursor-not-allowed transition cursor-pointer"
                ...
                <button
                  ...
                  className={`inline-flex items-center justify-center h-8 w-8 rounded-lg font-bold text-xs transition cursor-pointer ${
                    activePage === page
                      ...
                      : 'border border-slate-200 dark:border-slate-800 bg-white dark:bg-[#090f1e]/80 text-slate-600 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-slate-800 hover:text-slate-900 dark:hover:text-slate-200'
                  }`}
                >
                  {page}
                </button>

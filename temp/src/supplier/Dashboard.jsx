...
export function SupplierDashboard() {
  ...
  return (
    <motion.div variants={container} initial="hidden" animate="show" className="space-y-6">
      ...
      >
        <div className="absolute inset-0 bg-[linear-gradient(120deg,rgba(16,185,129,0.28),transparent_38%,rgba(124,58,237,0.22)_72%,transparent)]" />
        ...
        <div className="relative grid gap-6 p-6 lg:grid-cols-[1.35fr_0.65fr] lg:p-7">
          <div>
            <motion.span
              ...
              className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/10 px-3 py-1 text-xs font-bold text-emerald-100"
            >
            ...
            <div className="mt-6 flex flex-wrap gap-3">
              <Link to="/supplier/rfqs" className="inline-flex items-center gap-2 rounded-md bg-white px-4 py-2.5 text-sm font-bold text-slate-950 transition hover:bg-emerald-50">
                Review RFQs <ArrowRight className="h-4 w-4" />
              </Link>
              <Link to="/supplier/orders" className="inline-flex items-center gap-2 rounded-md border border-white/15 px-4 py-2.5 text-sm font-bold text-white transition hover:bg-white/10">
                Track orders
              </Link>
            </div>
          </div>
            ...
            {dashboardStages.map((stage, index) => (
              ...
              >
                <div className="flex items-center justify-between text-sm">
                  <span className="font-bold text-slate-100">{stage.label}</span>
                  <span className="font-black text-emerald-100">{stage.value}%</span>
                </div>
      ...
      <div className="grid gap-6 xl:grid-cols-[1.2fr_0.8fr]">
        <motion.div variants={item}>
          <Card>
            <CardHeader title="Revenue Mix" subtitle="Direct, indirect, and services trend" />
            <div className="p-4">
